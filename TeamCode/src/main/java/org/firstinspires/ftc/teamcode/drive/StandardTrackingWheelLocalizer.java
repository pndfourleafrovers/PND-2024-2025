    ...
    public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
        ...
        public static double LATERAL_DISTANCE = 10.064; // in; distance between the left and right wheels
        public static double FORWARD_OFFSET = 6.27; // in; offset of the lateral wheel
        public static double X_MULTIPLIER = 1.0; // Multiplier in the X direction on Right Side
